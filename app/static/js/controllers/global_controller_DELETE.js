...
export default class extends Controller {
    ...
    appStateValueChanged(value) {
        ...
        window.dispatchEvent(new CustomEvent('phototank:app-state-updated', { detail: value }))
        console.log("Global app state updated:", value, this.phototankStateKeyValue)
    }

    connect() {
        this.dispatch("updated", { detail: this.appStateValue })
        window.dispatchEvent(new CustomEvent('phototank:app-state-updated', { detail: this.appStateValue }))
